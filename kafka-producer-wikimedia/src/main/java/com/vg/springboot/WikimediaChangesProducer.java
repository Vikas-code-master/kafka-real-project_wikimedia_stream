...
public static final Logger LOGGER = LoggerFactory.getLogger(WikimediaChangesProducer.class);
	...
	public WikimediaChangesProducer(KafkaTemplate kafkaTemp) {
		this.kafkaTemplate = kafkaTemp;
	}
	
	public void sendMsg () throws InterruptedException {
		LOGGER.info("send msg is {} :", "WikimediaChangesProducer");
...
//
//        TimeUnit.MINUTES.sleep(10);
//		LOGGER.info("send msg is {} :", "WikimediaChangesProducerEnd");
	}
